package com.example.musicplayerdome.local.other;
...
import com.example.musicplayerdome.main.other.WowModel;
...
public class LocalPresenter extends LocalContract.Presenter {
    ...
    public LocalPresenter(MyLocalActivity view) {
        this.mView = view;
        this.mModel = new LocalModel();
    }


    @Override
    public void getSongDetailAll(String idlist,String cookie) {
      mModel.getSongDetailAll(idlist,cookie).subscribeOn(Schedulers.io())
    ...
    @Override
    public void getRecommendPlayList(String cookie) {
        mModel.getRecommendPlayList(cookie).subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    @Override
    public void getRecommendPlayListAgain(String cookie) {
        mModel.getRecommendPlayList(cookie).subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<MainRecommendPlayListBean>() {
                    @Override
    ...
    @Override
    public void getDailyRecommend(String cookie) {
        mModel.getDailyRecommend(cookie).subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    @Override
    public void getTopList(String cookie) {
        mModel.getTopList(cookie).subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    @Override
    public void getPlayList(String type, int limit,String cookie) {
        mModel.getPlayList(type, limit,cookie).subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    @Override
    public void getPlaylistDetail(long id,String cookie) {
        mModel.getPlaylistDetail(id,cookie).subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    @Override
    public void getMusicCanPlay(long id,String cookie) {
        Log.d(TAG, "getMusicCanPlay  id = " + id);
        mModel.getMusicCanPlay(id,cookie).subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    @Override
    public void getHighQuality(int limit, long before,String cookie) {
        mModel.getHighQuality(limit, before,cookie)
        ...
        @Override
        public void CollectionList(int t, long id,String cookie) {
            mModel.CollectionList(t,id,cookie).subscribeOn(Schedulers.io())
                    .observeOn(AndroidSchedulers.mainThread())
