...
public interface RecommendedContract {
    ...
    interface Model extends BaseModel {
        Observable<RecommendedVideoBean> getRecommendedVideos(String cookie);

        Observable<MusicCommentBean> getVideoComment(String id);

        Observable<RecommendedVideoBean> getGroupVideos(int id, String cookie);
    }
    abstract class Presenter extends BasePresenter<View,Model> {
        public abstract void getRecommendedVideos(String cookie);

        public abstract void getVideoComment(String id);

        public abstract void getGroupVideos(int id, String cookie);
    }
}
