...
public class RecommendedPresenter extends RecommendedContract.Presenter{
    ...
    @Override
    public void getRecommendedVideos(String cookie) {
        mModel.getRecommendedVideos(cookie).subscribeOn(Schedulers.io())
        ...
        @Override
        public void getGroupVideos(int id,String cookie) {
            mModel.getGroupVideos(id,cookie).subscribeOn(Schedulers.io())
                    .observeOn(AndroidSchedulers.mainThread())
                    .subscribe(new Observer<RecommendedVideoBean>() {
                        @Override
                        public void onSubscribe(Disposable d) {
