...
public class MinePresenter extends MineContract.Presenter {
    ...
    @Override
    public void getUserPlaylist(long uid,String cookie) {
        mModel.getUserPlaylist(uid,cookie).subscribeOn(Schedulers.io())
        ...
        @Override
        public void getUserPlaylistAgain(long uid,String cookie) {
            mModel.getUserPlaylist(uid,cookie).subscribeOn(Schedulers.io())
                    .observeOn(AndroidSchedulers.mainThread())
                    .subscribe(new Observer<UserPlaylistBean>() {
                        @Override
    ...
    @Override
    public void getUserDetail(long id,String cookie) {
        mModel.getUserDetail(id,cookie).subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    @Override
    public void getPlayHistoryList(long id, int type,String cookie) {
        mModel.getPlayHistoryList(id,type,cookie).subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    @Override
    public void getMvSublist(String cookie) {
        mModel.getMvSublist(cookie).subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    @Override
    public void getArtistSublist(String cookie) {
        mModel.getArtistSublist(cookie).subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    @Override
    public void getAlbumSublist(String cookie) {
        mModel.getAlbumSublistBean(cookie).subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
