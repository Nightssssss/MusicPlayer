...
public class SongPresenter extends SongContract.Presenter {
    ...
    @Override
    public void addHistorySong(String op, String pid, String tracks, String cookie) {
        mModel.addHistorySong(op, pid, tracks, cookie)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<HistorySongBean>(){
                    ...
                    @Override
                    public void onNext(HistorySongBean historySongBean) {
                        Log.e(TAG, "onNextll :" + historySongBean);
                    }
    ...
    @Override
    public void getSongDetail(long ids,String cookie) {
        mModel.getSongDetail(ids,cookie).subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    @Override
    public void likeMusic(long id,String cookie) {
        mModel.likeMusic(id,cookie).subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    @Override
    public void NolikeMusic(long id,String cookie) {
        mModel.NolikeMusic(false,id,cookie).subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<LikeMusicBean>() {
                    @Override
                    public void onSubscribe(Disposable d) {
    ...
    @Override
    public void getLikeList(long uid,String cookie) {
        mModel.getLikeList(uid,cookie).subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    @Override
    public void getLyric(long id,String cookie) {
        mModel.getLyric(id,cookie).subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
